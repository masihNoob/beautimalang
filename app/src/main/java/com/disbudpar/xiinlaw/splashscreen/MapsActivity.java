...
import com.disbudpar.xiinlaw.splashscreen.GPSLok.GPSLocation;
import com.disbudpar.xiinlaw.splashscreen.Model.IGoogleAPIService;
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                if(lastlocation!=null) {
                    ...
                    currentMarker1 = mMap.addMarker(new MarkerOptions()
...
//                    mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(lastlocation.getLatitude(), lastlocation.getLongitude()), 13f),3000,null);
