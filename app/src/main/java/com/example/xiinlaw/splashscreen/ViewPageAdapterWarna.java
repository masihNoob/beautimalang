...
public class ViewPageAdapterWarna extends PagerAdapter {
    ...
    private Integer [] images = {R.drawable.w1,R.drawable.w6,R.drawable.w3,R.drawable.w8,R.drawable.w5,R.drawable.w10,R.drawable.w11,R.drawable.w13,R.drawable.w14,R.drawable.w17,R.drawable.w19};
